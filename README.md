...
- `x402-surface-check.html` - browser checker and CLI landing page for x402 manifests, OpenAPI specs, item catalogs, direct paid endpoints, pasted no-payment 402 challenges, MPP payment headers, and x402 V2 requirements headers
