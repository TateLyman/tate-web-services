...
- `agent-skill-trust-check` - public static pre-install scanner for SKILL.md, OpenClaw, Hermes, MCP, and paid agent-skill marketplace listings. Repo: https://github.com/TateLyman/agent-skill-trust-check
