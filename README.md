...
- `agent-subscription-boundary-review.html` - paid private review for x402 and MPP flows where one paid agent request creates an account, subscription, API key, top-up, balance, or long-lived platform credential
