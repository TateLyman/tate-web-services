...
const commands = {
  help: [
    ...
    '  x402-fix     open paid x402 re-check and fix sprint',
    '  five-attack  open x402 five-attack review',
  ...
  services: [
    ...
    'x402-fix       $299    payment blocker sprint',
    'five-attack    $249    May 2026 x402 readiness review',
  ...
  proof: [
    ...
    'x402 fix       paid re-check and small authorized blocker fix',
    'five attack    May 2026 x402 finality, binding, replay, cache, and discovery review',
  ...
  'x402-fix': [
    'open /x402-fix-sprint.html',
    'paid private re-check or small authorized implementation sprint for one x402 launch blocker: CORS, cache headers, resource echo, discovery docs, registry proof, or idempotency notes.',
  ].join('\n'),
  'five-attack': [
    'open /x402-five-attack-review.html',
    'private May 2026 x402 readiness review mapped to finality, settlement binding, replay, cache/header handling, discovery steering, and patch order.',
  ].join('\n'),
  'mcp-trust': [
...
const routes = {
  ...
  'x402-fix': 'x402-fix-sprint.html',
  'five-attack': 'x402-five-attack-review.html',
